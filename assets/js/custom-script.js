...
function downloadResume(){
    window.open("assets/resume/Print--Resume-back-end-14.12.19.pdf", '_blank');
}

function printResume(){
    printJS({printable:'assets/resume/Print--Resume-back-end-14.12.19.pdf', type:'pdf', showModal:true})
    //window.open("assets/resume/Print--Resume-back-end-14.12.19.pdf", '_blank');
}